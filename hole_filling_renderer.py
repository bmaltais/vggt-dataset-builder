...
"""
        ...
        # ⚡ Bolt: Use a 3-channel uint8 texture for the final mask pass to optimize readback.
        # This reduces GPU-to-CPU bandwidth by 4x and avoids redundant CPU-side processing.
    ...
    def _read_final_color(self) -> np.ndarray:
        texture = self.final_mask_pass.color_textures[0]
        data = texture.read()
        # ⚡ Bolt: Read directly as 3-channel uint8.
        # This reduces readback bandwidth by 4x (12 bytes/pixel -> 3 bytes/pixel)
        # and eliminates expensive CPU-side float clipping, scaling, and conversion.
