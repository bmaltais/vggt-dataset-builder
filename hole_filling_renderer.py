...
"""
    ...
    def _read_final_color(self) -> np.ndarray:
        texture = self.final_mask_pass.color_textures[0]
        data = texture.read()
        # ⚡ Bolt: Optimize readback by using a 3-component uint8 texture.
        # This reduces GPU-CPU bandwidth by ~5.3x and eliminates CPU-side
        # float math (scaling, clipping, casting).
