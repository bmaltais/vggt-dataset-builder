...
"""
    ...
    def _read_final_color(self) -> np.ndarray:
        texture = self.final_mask_pass.color_textures[0]
        # ⚡ Bolt: Optimize readback by using a 3-channel uint8 texture.
        # This reduces bandwidth by ~5.3x (16 bytes/px -> 3 bytes/px) and eliminates
        # expensive CPU-side float scaling, clipping, and conversion.
        data = texture.read()
