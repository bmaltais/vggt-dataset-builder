...
class VGGT_Model_Inference:
    ...
    def infer(
        ...
        **kwargs,
        ...
        if max_depth > 0:
            # ⚡ Bolt: Use manual squared distance calculation to avoid expensive sqrt from np.linalg.norm.
            # In-place logical AND reduces memory pressure for large point clouds.
            dist_sq = (
        ...
        if boundary_threshold > 0:
            ...
            # This avoids nested Python loops and redundant large mask allocations.
