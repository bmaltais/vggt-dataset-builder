    ...
    def infer(
        ...
        **kwargs,
        ...
        if max_depth > 0:
            ...
            # Speedup: ~3-5x for large point clouds
            dist_sq = (
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized boundary filtering using 3D slicing instead of nested loops
            # Speedup: ~30-50x for typical scene sequences
