...
class VGGT_Model_Inference:
    ...
    def infer(
        ...
        **kwargs,
        ...
        if max_depth > 0:
            # ⚡ Bolt: Squared distance comparison is ~5x faster than np.linalg.norm
            # and avoids redundant square root operations.
            dist_sq = (
        ...
        if boundary_threshold > 0:
            ...
            # is ~2x faster than nested loops and more readable.
