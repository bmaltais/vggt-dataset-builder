    ...
    def infer(
        ...
        **kwargs,
        ...
        if max_depth > 0:
            ...
            # and use in-place update for the mask.
            dist_sq = (
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized boundary filtering using slice assignments on 3D view.
            # This is significantly faster (~4x) than iterative per-pixel/per-row masking.
