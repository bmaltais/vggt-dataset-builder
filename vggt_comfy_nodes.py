    ...
    def infer(
        ...
        **kwargs,
        ...
        if max_depth > 0:
            ...
            # ⚡ Bolt: Using squared distance avoids expensive np.linalg.norm (sqrt)
            sq_dist = (
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized boundary filtering using slice assignments on reshaped view.
            # This replaces nested Python loops with efficient NumPy operations.
        ...
        if mask_white_bg:
            # ⚡ Bolt: Use consistent threshold and in-place operator for white background filtering.
