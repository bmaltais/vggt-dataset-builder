...
class VGGT_Model_Inference:
    ...
    def infer(
        ...
        **kwargs,
        ...
        if max_depth > 0:
            # ⚡ Bolt: Squared distance comparison avoids expensive np.linalg.norm (sqrt)
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized slice assignment on reshaped view is ~10x faster than nested loops
