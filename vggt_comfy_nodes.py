    ...
    def infer(
        ...
        **kwargs,
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized boundary filtering using reshaped view for massive speedup
            # over nested loops.
        ...
        if mask_black_bg:
            ...
            # Using in-place &= reduces memory overhead.
            color_sum = (
                colors_all_frames[:, 0]
                + colors_all_frames[:, 1]
                + colors_all_frames[:, 2]
        ...
        if mask_white_bg:
            # ⚡ Bolt: Use consistent 241/255 threshold and in-place &= operator.
