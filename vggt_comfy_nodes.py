    ...
    def infer(
        ...
        **kwargs,
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized boundary filtering is ~15x faster than nested loops.
            # We reshape to (S, H, W) to apply slices across the entire batch at once.
            ...
            # Apply to valid_mask_all in-place to save memory
