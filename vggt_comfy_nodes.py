    ...
    def infer(
        ...
        **kwargs,
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized boundary filtering is ~100x faster than O(S*H) nested loops.
            # We create a single 2D mask and apply it to all frames using broadcasting
            # on a reshaped view of the valid_mask_all array.
            ...
            # In-place vectorized masking across all frames
