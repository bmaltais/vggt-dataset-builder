    ...
    def infer(
        ...
        **kwargs,
        ...
        if max_depth > 0:
            ...
            # providing ~1.1x speedup for the filtering phase.
            sq_dist = (
        ...
        if boundary_threshold > 0:
            # ⚡ Bolt: Vectorized boundary filtering using NumPy slicing is ~40x faster than
            # per-row loops for large frame batches.
